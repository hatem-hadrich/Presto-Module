...
describe('Connecting with google in front office', function() {
    ...
    describe('Connection on google site', function() {
        ...
        it('should connecting with google account', function (done) {
            global.fctname = this.test.title;
            if(this.client.isExisting(this.selector.FO.Google.username_input) === true){
                this.client
    ...
    describe('The Purchase of a product', function () {
        ...
        describe('Validate the cart', function () {
            ...
            it('should click on google button', function (done) {
                global.fctname = this.test.title;
                this.client
                    .moveToObject(this.selector.FO.Commande.first_google_logo)
                    .click(this.selector.FO.Commande.first_google_logo)
                    .pause(3000)
                    .call(done);
            });
