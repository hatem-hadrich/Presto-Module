...
var visible_allow_button = false;
...
describe('Connecting with twitter in front office', function() {
    ...
    describe('Connection on twitter site', function() {
        ...
        it('should acces to twitter site', function (done) {
            ...
            this.client
                ...
                .pause(2000)
                .isVisible(this.selector.FO.Twitter.allow_button).then(function (visible) {
                visible_allow_button = visible;
            })
                .call(done);
        });
        ...
        it('should connecting with twitter account', function (done) {
            ...
            if(visible_allow_button) {
                ...
                this.client
                    .waitForExist(this.selector.FO.Twitter.username_input, 90000)
    ...
    //             global.fctname = this.test.title;
    //             this.client
    //                 .waitForExist(this.selector.FO.ProductPage.command_button_checkout, 90000)
    ...
    //             global.fctname = this.test.title;
    //             this.client
    //                 .click(this.selector.FO.ProductPage.command_button_checkout)
    //                 .call(done);
    //         });
    //
    ...
    //             global.fctname = this.test.title;
    //             this.client
    //                 .waitForExist(this.selector.FO.ProductPage.checkout_step2_continue_button, 90000)
    //                 .click(this.selector.FO.ProductPage.checkout_step2_continue_button)
    //                 .waitForExist(this.selector.FO.ProductPage.checkout_step3_continue_button, 90000)
    //                 .click(this.selector.FO.ProductPage.checkout_step3_continue_button)
    //                 .call(done);
    //         });
    //
    ...
    //             global.fctname = this.test.title;
    //             this.client
    //                 .waitForExist(this.selector.FO.ProductPage.checkout_step4_payment, 90000)
    //                 .getText(this.selector.FO.ProductPage.checkout_total).then(function (text) {
    //                 var checkout_total = text;
    //                 should(checkout_total).be.equal(my_price);
    //             })
    //                 .click(this.selector.FO.ProductPage.checkout_step4_payment)
    //                 .call(done);
    //         });
    //
