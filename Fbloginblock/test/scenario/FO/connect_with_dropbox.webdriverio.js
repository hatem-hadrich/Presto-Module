...
describe('Connecting with dropbox in front office', function() {
    ...
    describe('Connection on dropbox site', function() {
        ...
        it('should connecting with dropbox account', function (done) {
            global.fctname = this.test.title;
            if(this.client.isExisting(this.selector.FO.Dropbox.username_input) === true){
                this.client
    ...
    describe('The Purchase of a product', function () {
        ...
        describe('Validate the cart', function () {
            ...
            it('should click on dropbox button', function (done) {
                global.fctname = this.test.title;
                this.client
                    .moveToObject(this.selector.FO.Commande.first_dropbox_logo)
                    .click(this.selector.FO.Commande.first_dropbox_logo)
                    .pause(3000)
                    .call(done);
            });
