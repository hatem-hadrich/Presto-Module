...
describe('Test case n°2.1 : Add new category in BO', function(){
    ...
    describe('Add category', function(done){
        ...
        it('Should enter the title of category ', function(done){
            ...
            this.client
                ...
                .setValue(this.selector.category_title, 'category-' + date_time)
                .pause(2000)
    ...
    describe('Check category in BO', function(done){
        ...
        it('Should check the previous category title ', function(done){
            global.fctname= this.test.title;
            this.client
                .waitForExist(this.selector.category_title_table, 90000)
                .pause(2000)
                .getText(this.selector.category_title_table).then(function(text) {
                should(text).be.equal("category-" + date_time)
            })
                .call(done);
        });
    });
