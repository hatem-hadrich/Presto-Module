...
module.exports = {
	...
	//Installation
	 ...
	 //BO
		...
		save_boutique_parametre:'//*[@id="configuration_fieldset_general"]/div[3]/button',
        boutique_parametre:'//*[@id="subtab-ShopParameters"]/a',
		arrondi_rules:'//*[@id="conf_id_PS_PRICE_ROUND_MODE"]/div[1]/select',
        arrondi_type:'//*[@id="conf_id_PS_ROUND_TYPE"]/div[1]/select',
        activate_sandbox:'//*[@id="fieldset_0"]/div[2]/div[1]/div/span/label[1]',
        setting_btn:'//*[@id="content"]/div[5]/ul/li[2]/a',
        save_config_paypal:'//*[@id="configuration_form_submit_btn"]',
		search_btn:'//*[@id="main-div"]/div[3]/div/div/div[2]/div/div[5]/div/div[2]/div/span/i',
		option_module_btn:'//*[@id="modules-list-container-native"]/div/div/div/div[5]/div[2]/button',
		config_btn:'//*[@id="modules-list-container-native"]/div/div/div/div[5]/div[2]/div/li[5]/form/button',
		setting_paypal:'//*[@id="paypal_conf"]/div[4]/div[1]/div/div/a',
		client_id_setting:'/html/body/div[4]/div/div/div/div/form/p[2]/input',
		client_secret_setting:'/html/body/div[4]/div/div/div/div/form/p[3]/input',
		valid_setting_paypal:'/html/body/div[4]/div/div/div/div/form/p[6]/button[2]',
		confirme_msg:'//*[@id="content"]/div[4]/div',
	//FO
        ...
        all_product:'//*[@id="content"]/section[2]/div[1]/a',
        home_logo_url:'//*[@id="_desktop_logo"]/a',
        First_product:'//*[@id="js-product-list"]/div/article[1]/div/a',
        add_to_cart_lifestyle:'//*[@id="main"]/div/div[1]/div[2]/div[2]/div[2]/form/div[2]/div[1]/div[2]/button',
